	...
	<body class="english">
		<div class="content">
			...
			<div class="videoContent">	            	
				<video controls poster="wallpaper_01.jpg">
					<source src="video_01.webm" type="video/webm">
					<source src="video_01.ogg" type="video/ogg">
					<source src="video_01.mp4" type="video/mp4">
				</video>
			</div>
			<div class="videoContent">				
				<video controls poster="wallpaper_02.jpg">
					<source src="video_02.webm" type="video/webm">
					<source src="video_02.ogg" type="video/ogg">
